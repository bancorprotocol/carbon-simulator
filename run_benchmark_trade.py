...
from benchmark.trade import impl, spec
...
run('resources/benchmark/trade/ArbitraryTrade' , '2', '0')
run('resources/benchmark/trade/EthUsdcTrade'   , '0', '0.0000000009')
run('resources/benchmark/trade/ExtremeSrcTrade', '2', '0.0005326707')
run('resources/benchmark/trade/ExtremeTrgTrade', '2', '0.0005329546')
