...
# SHIB/USDC
user_y,user_z,user_A,user_B,user_S,xS = encode_user_inputs(0.00001555, 0.00001453, 100000, 100000, 18, 6, ONE_EXPONENT) ## USDC-side order
...
### tradeByTarget 1 USDC for SHIB - USDC-side order ###
sourceDecimals = 18
targetDecimals = 6
amount = 1
...
print(dy / 10**sourceDecimals, "SHIB")
# print(diagnostics)
if len(diagnostics['len']['error']) > 0:
    raise
print("\n")

### tradeBySource 10000 SHIB for USDC - USDC-side order ###
sourceDecimals = 18
targetDecimals = 6
amount = 10000
dx, dy, diagnostics = getTradeTargetAmount_bySource(amount * 10**sourceDecimals ,storage)
print('TradeBySource')
print(f"Trade {amount} SHIB for USDC")
print('inputAmount', dx, 'outputAmount', dy)
print(dy / 10**targetDecimals, "USDC")
# print(diagnostics)
if len(diagnostics['len']['error']) > 0:
    raise
print("\n")
